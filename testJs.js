...
var q = {
    ...
    3:{"title":"직원분이 주문을 잘못 받았다. 이때 당신의 생각은?","type":"TF","A":"많이 피곤하신가보다. 금방 다시 만들어주시겠지.","B":"왜 잘못 받으셨을까? 내가 발음이 뭉게졌나? 스피치 학원 다녀야하나…"},
    4:{"title":"모처럼 날씨 좋은 주말, 당신은 카페에 왜 가는가?","type":"JP","A":"가서 작업도 하고, 일기도 써야지~","B":"일단 가서 생각해야지! "},
}
